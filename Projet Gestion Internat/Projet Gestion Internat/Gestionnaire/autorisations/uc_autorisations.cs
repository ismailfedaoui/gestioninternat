...
namespace Projet_Gestion_Internat
{
    ...
    public partial class uc_autorisations : UserControl
    {
        int l = -1;
        public uc_autorisations()
        {
            InitializeComponent();
        }

        private void uc_autorisations_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select cfe , s.prenom,s.nom,type_autorisation,description_autorisation ,date_autorisation,heure_autorisation,duree_autorisation,g.prenom+' '+g.nom from autorisation a join stagiaire s on a.#cfe=s.cfe join gestionnaire g on a.#id_gest=g.id_gest ", Form1.cx);
            Form1.cx.Open();
            ...
            comboBox1.Items.Add("Sortie");
            comboBox1.Text = "Sortie";
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("insert into autorisation values(@type,@desc,@heure,@duree,@id_gest,@cfe,getdate())", Form1.cx);
            cmd.Parameters.AddWithValue("@type",comboBox1.Text);
            cmd.Parameters.AddWithValue("@desc",richTextBox1.Text);
            cmd.Parameters.AddWithValue("@heure",maskedTextBox1.Text);
            ...
            SqlCommand cmd2 = new SqlCommand("insert into [dbo].[stagiaire_gestionnaire] values(getdate(),'Autorisation',@cfe,@id_gest)", Form1.cx);
        ...
        void  afficher( int pos)
        {
            ...
            textBox5.Text = dataGridView1.Rows[pos].Cells[7].Value.ToString();
            richTextBox1.Text = dataGridView1.Rows[pos].Cells[4].Value.ToString();
            maskedTextBox1.Text= dataGridView1.Rows[pos].Cells[6].Value.ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("rechercher_autorisation", Form1.cx);
