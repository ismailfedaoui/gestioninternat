...
{
    public partial class uc_rapport_contr : UserControl
    {
        ...
        private void uc_rapport_contr_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("rechercher_contribution", Form1.cx);
            ...
            {
                if (r.Cells[3].Value.ToString() == "Complete") s += 200;
                else if (r.Cells[3].Value.ToString() == "Demi Pension") s += 100;
            }
        ...
        {
            imprimer_contr f = new imprimer_contr();
            f.Show();
        }
